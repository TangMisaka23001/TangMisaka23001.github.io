...
tags:
  ...
  - Java
  - 技术
pubDatetime: 2017-07-08T18:20:48.000Z
description: >-
  $1简述 ============== 
  在OpenCV配置安装完成之后,先去看了一下官方的教程和例子,$1,这是官方提供的一个面对Java开发者的快速的介绍,但是其中只有两个Demo,第一个就是配置时的测试代码.这里主要来看一下第二个例子. 
  $1开始 ==============  在官方的这个介绍中还介绍了Sca...
---
[](#简述 "简述")简述
==============
