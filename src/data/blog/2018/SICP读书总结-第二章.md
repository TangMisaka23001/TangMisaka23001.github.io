...
tags:
  ...
  - Lisp
  - 生活
pubDatetime: 2018-08-28T22:17:45.000Z
description: >-
  $1前言 ==============  实习之后感觉节奏和学校还是有些变化的,不知不觉俩月也过去了,SICP却才开始第二章的总结,需要督促自己了. 
  第二章主要是:  *   复杂数据的抽象 *   数据导向编程 *   数据类型闭包 *   符号表达式处理(引用)  >
  现在到了数学抽象中最关键的一步:让我们忘记这...
---
[](#前言 "前言")前言
==============
