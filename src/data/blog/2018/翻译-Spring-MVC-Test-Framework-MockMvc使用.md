...
tags:
  ...
  - Test
  - 技术
pubDatetime: 2018-10-18T20:44:18.000Z
description: >-
  前言 国庆回来之后算是正是开始了Spring
  Boot的工作,而Java组里因为没有写任何的单元测试,每次测试都是靠Swagger的web页面自己填参数来测试,于是在这次新版本的迭代中我变成了第一个被要求贯彻实施每个controller都要写测试的人,不过**单元测试,从我做起**,真的很重要啊. 
  然后在选择的时候发...
---
# 前言
