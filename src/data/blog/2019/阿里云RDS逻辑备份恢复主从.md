...
tags:
  ...
  - 技术
mathjax: false
pubDatetime: 2019-03-02T15:59:20.000Z
description: >-
  问题产生 在主从备份恢复没多久之后,从库又出现了新的错误:  
  并且大量出现了这个错误日志,同时MySQL的目录下relay_log大量堆积.并且服务器一直处于无法正常启动的情况下,在参考了$1之后,使用下面的方法正常启动的MySQL的进程: 
  个人估计原因是由于主从同步一直失败导致MySQL目录下relay_log堆...
---
