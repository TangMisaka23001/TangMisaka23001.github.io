...
tags:
  - 静态网站
  - 技术
pubDatetime: 2024-01-24T11:45:14.000Z
description: >-
  因为目前博客的主题在文字排版上总感觉有一些问题，再加上想做一个个人的知识整合网站于是就开始折腾Docusaurus。 创建项目 1.
  新建一个GitHub仓库，使用codespace打开。 2. 在命令行中初始化docusaurus      3. 将文件移动到当前目录： 4.
  提交变更，初始化完成  Github A...
---
