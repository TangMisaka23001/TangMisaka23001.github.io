...
description: "mysql实际使用中的经典问题和解决方案 - 可扩展性：并发量提升导致的TPC-C性能下降 \t- 使用线程池 - 不支持 hash join - 大规模部署中MySQL半同步复制的挑战 \t- Raft - 在组复制的默认模式下，跨数据中心的吞吐量与理论预期存在显著偏差 - 组复制：本地主机部署报告不可达  九个令人困惑..."
---
