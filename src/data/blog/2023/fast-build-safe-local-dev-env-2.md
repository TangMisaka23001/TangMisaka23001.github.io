...
tags:
  ...
  - tls
  - 技术
pubDatetime: 2023-05-02T11:45:14.000Z
description: >-
  上文使用了域名来进行本地开发的https配置，这次我们换用自购域名解析到127.0.0.1的形式来进行配置。 
  首先我们需要购买一个域名并且添加解析到127.0.0.1：    因为我们的域名指向本地而不是公网可访问的IP，所以我们需要使用DNS
  challenge的形式来获取tls证书。各大厂商的DNS challe...
---
