...
# 快速搭建服务器
双11薅了TX云三年服务器的羊毛，然后买了个域名，计划着把之前一部分在HK服务器上和树莓派上的服务都整到国内的服务器上，一是访问速度更快，二是比家里的树梅派更稳定一点（老是断点）。由于之前用Docker Compose搭建了一部分的服务感觉很方便，所以就计划这次的服务器上所有的服务都基于Docker和Docker Compose来搭建。
## composerize
